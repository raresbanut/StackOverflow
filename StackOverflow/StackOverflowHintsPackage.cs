...
namespace StackOverflow
{
    ...
    [ProvideToolWindow(typeof(StackOverflowHints))]
    [Guid(PackageGuidString)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    public sealed class StackOverflowHintsPackage : AsyncPackage
    {
        /// <summary>
        /// StackOverflowHintsPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "8dd26f86-d4e9-4232-b657-093ecc44abf4";

        /// <summary>The dte.</summary>
        private EnvDTE80.DTE2 dte;

        /// <summary>The dte initializer.</summary>
        private DteInitializer dteInitializer;

        /// <summary>The get dte 2.</summary>
        /// <returns>The <see cref="DTE2"/>.</returns>
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await StackOverflowHintsCommand.InitializeAsync(this);
            base.Initialize();
            InitializeDte();
        }

        /// <summary>The initialize dte.</summary>
